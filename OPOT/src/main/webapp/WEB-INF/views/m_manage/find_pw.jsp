...
<div class="container" align="center">
	...
	<div class="pagetitle">
		...
		<h5>아이디와 가입할 때 입력하신 전화번호, 이메일을 입력해주세요</h5>
		<h5>정보가 일치하면 이메일로 임시 비밀번호를 보내드립니다</h5>
	</div>
	<table class="table table-bordered" id="login_table" style="width:500px; margin:auto;">
	 <tr>
	 	<th>아이디</th>
	 	<td> 
	 		<input type="text" id="mem_id" name="mem_id" class="form-control" onblur="idCheck()" required>
	 ...
	 <input class="btn btn-default" type="submit" id="findPwBtn" value="비밀번호 찾기">
